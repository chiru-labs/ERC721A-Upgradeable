...
contract ERC721AOwnersExplicitMockUpgradeable is ERC721A__Initializable, ERC721AOwnersExplicitUpgradeable {
    function __ERC721AOwnersExplicitMock_init(string memory name_, string memory symbol_)
        internal
    ...
    function __ERC721AOwnersExplicitMock_init_unchained(string memory, string memory)
        internal
        onlyInitializingERC721A
    {}
